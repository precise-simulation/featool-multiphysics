...
%
%   [ SOUT, NEW_TAGS ] = GEOM_APPLY_CHAMFER( SIN, TAGS, D ) Applies
%   chamfers to the geometry objects in finite element or geometry
%   struct SIN with the specified TAGS. D specifies the chamfer
%   distance to apply.
