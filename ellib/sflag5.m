function [ vBase, nLDof, xLDof, sfun ] = sflag5( i_eval, n_sdim, n_vert, varargin )
...
if ( (n_vert==n_sdim+1) || (n_sdim==1) )   % Simplex cells (1D line, 2D triangle, 3D tetrahedron).
  ...
  switch n_sdim
    ...
    case 1   % 1D Line cells.
      ...
      [vBase,nLDof,xLDof,sfun] = sf_line_P5(i_eval,n_sdim,n_vert,varargin{:});

    case 2   % 2D Triangular cells.

      [vBase,nLDof,xLDof,sfun] = sf_tri_P5(i_eval,n_sdim,n_vert,varargin{:});

    case 3   % 3D Tetrahedral cells.

      [vBase,nLDof,xLDof,sfun] = sf_tet_P5(i_eval,n_sdim,n_vert,varargin{:});
  ...
  switch n_sdim
    ...
    case 2   % 2D Quadrilateral cells.
      ...
      [vBase,nLDof,xLDof,sfun] = sf_quad_Q5(i_eval,n_sdim,n_vert,varargin{:});

    case 3   % 3D Hedahedral cells.

      [vBase,nLDof,xLDof,sfun] = sf_hex_Q5(i_eval,n_sdim,n_vert,varargin{:});
