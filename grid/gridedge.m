...
%
%   [ E, EV ] = GRIDEDGE( C, N_SDIM ) Generates an array E with global edge numbers. Input data is an
%   array C with cell connectivities and N_SDIM specifying the number of space dimensions.
%
