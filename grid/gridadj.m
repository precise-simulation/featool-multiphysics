...
%
%   [ A ] = GRIDADJ( C, N_SDIM ) Generates an array A with indices to neighboring cells and
%   zeros where no neighbors are found. Input data is an array C with cell connectivities
...
%                                          the edge/face belongs to a boundary.
