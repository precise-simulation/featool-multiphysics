...
%
%   [ GEOM ] = IMPEXP_OBJ( FILE_NAME, MODE, GEOM ) Import and export
%   of 3D CAD geometries and in Wavefront OBJ format. Only triangular
%   facets with the Obj fields v for vertices, f for faces, and g for
%   boundary groups are supported.
%
