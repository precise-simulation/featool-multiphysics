...
%
%   [ VEVAL ] = EVALEXPR0( S_EXPR, XI, IND_S, IND_C, IND_E, PROB,
%   AJAC, GRADREC ) Given a valid PROB struct evaluates the expression
%   S_EXPR on cells with index IND_C at point XI in local coordinates.
%
...
%
%   See also EVALEXPR, EVALDVAR, EVALSFUN
