...
- Full support for FEniCS external solver
  - Supports converstion of most FEATool models
    to FEniCS Python simulation scripts
  - Time dependent and nonstationary problems
  - Nonlinear and discontinous coefficients
- Improved postprocessing and visulalization
  - Faster and more efficient 3D graphics
  - GUI support for more colors and colomaps,
...
- Faster expression evalution via nodal interpolation
