...
%
%   [ TF ] = FEACHECKMEX( MEX_FILE, ...ARGS ) Check/test for valid mex file usage.
%   MEX_FILE is an optional mex file to check/test against (default
%   fsparse), and ARGS optional input arguments in test tex function call.
