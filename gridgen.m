...
%   object. Accepts the following property/value pairs (valid for all
%   grid generation algorithms).
%
%       Property    Value/{Default}           Description
%       -----------------------------------------------------------------------------------
%       gridgen     string {default}          Grid generation algorithm: default, gmsh
%                                                gridgen2d, mesh2d, triangle, or quad
...
%   the corresponding grid generation code (default, gmsh, gridgen2d,
%   mesh2d, triangle, or quad).
%
