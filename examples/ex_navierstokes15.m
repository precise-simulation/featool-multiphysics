function [ fea, out ] = ex_navierstokes15( varargin )
%EX_NAVIERSTOKES15 2D Channel flow driven by periodic pressure difference.
%
%   [ FEA, OUT ] = EX_NAVIERSTOKES15( VARARGIN ) Sets up and solves
%   stationary Poiseuille flow in a rectangular channel driven by a
%   periodic pressure difference. The flow profile is constant and
%   should assume a parabolic profile u(y)=dp/dx/2/miu*y*(h-y).
...
[fea.bdr.n{3}{[i_inflow i_outflow]}] = deal( ['solve_hook_',s_fname] );
