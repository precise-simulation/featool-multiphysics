...
%
%   [ FEA, OUT ] = EX_HEATTRANSFER7( VARARGIN ) Transient heat diffusion problem
%   with analytic solution. A 1 m rod is kept at fixed temperature on one end
%   and constant heat flux at the other as in the illustration.
%
%              +---------- L=1m ----------+ T = 25
%            q_n = 1       T(t=0) = 25
%
