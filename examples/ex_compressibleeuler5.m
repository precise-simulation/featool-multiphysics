function [ fea, out ] = ex_compressibleeuler5( varargin )
%EX_COMPRESSIBLEEULER5 3D Compressible inviscid flow over a bump.
%
%   [ FEA, OUT ] = EX_COMPRESSIBLEEULER5( VARARGIN ) Sets up and
%   solves a stationary 3D compressible Euler equation problem for
%   supersonic flow over a cylindrical bump.
%
%   Reference:
%
