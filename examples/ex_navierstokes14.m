...
%
%   [ FEA, OUT ] = EX_NAVIERSTOKES14( VARARGIN ) Sets up and solves stationary Poiseuille
%   flow in a rectangular channel driven by a pressure difference. The flow profile is
%   constant and should assume a parabolic profile ( u(y)=dp/dx/2/miu*y*(h-y) ).
